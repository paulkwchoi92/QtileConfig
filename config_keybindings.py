...
SHUTDOWN_MODIFIER = [MOD, CONTROL, ALT]
RESTART = "r"
SHUTDOWN = "q"
...
SPAWN_CMD_KEYS = [
    ...
    # Takes section screenshot and copies it to clipboard
    ([ALT, SHIFT], "3", "xfce4-screenshooter -r -c"),
    ([ALT, SHIFT], "4",
     f"xfce4-screenshooter -r -s {HOME}/Pictures/Screenshots")
